...
async function runSui1CardSequentialAudit() {
  console.log("================================================================================");
  console.log("📊 REAL SINGLE-CARD 24-HOUR SEQUENTIAL LIFECYCLE SIMULATION (SUIUSDT)");
  console.log("================================================================================");
  ...
  console.log(`Loaded ${allKlines.length} 1-minute candles for SUIUSDT.`);
  ...
  console.log("\n================================================================================");
  console.log(`🏆 SUIUSDT SINGLE-CARD 24-HOUR SIMULATION RESULTS:`);
  ...
  let markdown = `# 🛡️ Single Trading Card 24-Hour Sequential Lifecycle Report (SUIUSDT)
...
## 🏆 1-Card Sequential Summary for SUIUSDT
...
## 📅 Step-by-Step Timeline of 1 Card Lifecycle for SUIUSDT
...
`;
  ...
  completedTrades.forEach(t => {
    if (t.status === 'TP_HIT') {
      markdown += `| **Trade #${t.tradeNo}** | \`${t.entryTimeStr}\` | **$${t.buyPrice.toFixed(4)}** | **${t.obiPct}%** | **$${t.tpPrice}** | \`${t.exitTimeStr}\` | **${t.durationMins} Mins** | ✅ +0.60% TP FILLED |\n`;
    } else {
      markdown += `| **Trade #${t.tradeNo}** | \`${t.entryTimeStr}\` | **$${t.buyPrice.toFixed(4)}** | **${t.obiPct}%** | **$${t.tpPrice}** | *Holding...* | *Active...* | ⏳ PENDING SAFE HOLD |\n`;
    }
  });

  const artifactPath = 'C:\\Users\\Hi\\.gemini\\antigravity\\brain\\cdfb16e8-d8e7-4868-967f-4d9834b72016\\sui_single_card_24h_sequential_lifecycle_report.md';
  fs.writeFileSync(artifactPath, markdown);
  console.log(`\n✅ Artifact written to: ${artifactPath}`);
}

runSui1CardSequentialAudit().catch(console.error);
